...
const FeaturesList = () => {
  ...
  const cardsData = [
    ...
    },
    {
      ...
      description:
        "Authenticates user with GitHub for enhanced security and tracks continuous session data.",
    },
    {
      id: 6,
      alt: "prometheus",
      ...
      description:
        "View comprehensive cluster data with Prometheus-powered metrics analysis",
    },
    {
      id: 7,
      alt: "topics",
      ...
      description:
        "Analyze topics metadata, and create new topics with customizable parameters",
    },
    {
      id: 8,
      alt: "cookies",
      ...
      title: "Sessions",
      description:
        "Ensures persistent login across sessions, maintaining user authentication even when exiting the web application.",
    },
  ];
  ...
  return (
    <div className="flex flex-wrap justify-center">
      ...
      {cardsData.map((card) => (
        <motion.div
          key={card.id}
          className="card mx-2 my-2 w-96 max-w-xs rounded-xl border border-solid border-gray-500 bg-transparent shadow-xl"
        >
